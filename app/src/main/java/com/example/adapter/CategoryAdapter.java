...
import com.app.jobportalw.CategoryItemActivity;
...
public class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.ItemRowHolder> {
    ...
    public void onBindViewHolder(ItemRowHolder holder, final int position) {
        ...
        Picasso.with(mContext).load(singleItem.getCategoryImage()).placeholder(R.drawable.placeholder).into(holder.image);
